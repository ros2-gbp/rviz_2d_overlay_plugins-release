## rviz_2d_overlay_plugins (rolling) - 1.4.2-1

The packages in the `rviz_2d_overlay_plugins` repository were released into the `rolling` distro by running `/tmp/venv/bin/bloom-release --rosdistro rolling rviz_2d_overlay_plugins` on `Fri, 31 Jul 2026 11:17:25 -0000`
...
## rviz_2d_overlay_plugins (lyrical) - 1.4.2-1

The packages in the `rviz_2d_overlay_plugins` repository were released into the `lyrical` distro by running `/tmp/venv/bin/bloom-release --rosdistro lyrical rviz_2d_overlay_plugins` on `Fri, 31 Jul 2026 11:14:55 -0000`
...
## rviz_2d_overlay_plugins (kilted) - 1.4.2-1

The packages in the `rviz_2d_overlay_plugins` repository were released into the `kilted` distro by running `/tmp/venv/bin/bloom-release --rosdistro kilted rviz_2d_overlay_plugins` on `Fri, 31 Jul 2026 11:13:39 -0000`
...
## rviz_2d_overlay_plugins (jazzy) - 1.4.2-1

The packages in the `rviz_2d_overlay_plugins` repository were released into the `jazzy` distro by running `/tmp/venv/bin/bloom-release --rosdistro jazzy rviz_2d_overlay_plugins` on `Fri, 31 Jul 2026 10:14:38 -0000`
...
## rviz_2d_overlay_plugins (humble) - 1.4.2-1

The packages in the `rviz_2d_overlay_plugins` repository were released into the `humble` distro by running `/tmp/venv/bin/bloom-release --rosdistro humble rviz_2d_overlay_plugins` on `Fri, 31 Jul 2026 09:57:52 -0000`
...
## rviz_2d_overlay_plugins (jazzy) - 1.4.1-1

The packages in the `rviz_2d_overlay_plugins` repository were released into the `jazzy` distro by running `/usr/bin/bloom-release --rosdistro jazzy --override-release-repository-push-url git@github.com:ros2-gbp/rviz_2d_overlay_plugins-release.git rviz_2d_overlay_plugins` on `Sat, 14 Mar 2026 09:04:59 -0000`
...
## rviz_2d_overlay_plugins (kilted) - 1.4.1-1

The packages in the `rviz_2d_overlay_plugins` repository were released into the `kilted` distro by running `/usr/bin/bloom-release --rosdistro kilted --override-release-repository-push-url git@github.com:ros2-gbp/rviz_2d_overlay_plugins-release.git rviz_2d_overlay_plugins` on `Sat, 14 Mar 2026 09:02:16 -0000`
...
## rviz_2d_overlay_plugins (rolling) - 1.4.1-1

The packages in the `rviz_2d_overlay_plugins` repository were released into the `rolling` distro by running `/usr/bin/bloom-release --rosdistro rolling --override-release-repository-push-url git@github.com:ros2-gbp/rviz_2d_overlay_plugins-release.git rviz_2d_overlay_plugins` on `Sat, 14 Mar 2026 09:00:50 -0000`
...
## rviz_2d_overlay_plugins (humble) - 1.4.0-1

The packages in the `rviz_2d_overlay_plugins` repository were released into the `humble` distro by running `/usr/bin/bloom-release --rosdistro humble rviz_2d_overlay_plugins --override-release-repository-push-url git@github.com:ros2-gbp/rviz_2d_overlay_plugins-release.git` on `Tue, 11 Nov 2025 15:35:06 -0000`
...
## rviz_2d_overlay_plugins (jazzy) - 1.4.0-1

The packages in the `rviz_2d_overlay_plugins` repository were released into the `jazzy` distro by running `/usr/bin/bloom-release --rosdistro jazzy rviz_2d_overlay_plugins --override-release-repository-push-url git@github.com:ros2-gbp/rviz_2d_overlay_plugins-release.git` on `Tue, 11 Nov 2025 15:33:56 -0000`
...
## rviz_2d_overlay_plugins (rolling) - 1.3.1-1

The packages in the `rviz_2d_overlay_plugins` repository were released into the `rolling` distro by running `/usr/bin/bloom-release --rosdistro rolling rviz_2d_overlay_plugins --override-release-repository-push-url git@github.com:ros2-gbp/rviz_2d_overlay_plugins-release.git` on `Sun, 01 Jun 2025 09:48:35 -0000`
...
## rviz_2d_overlay_plugins (kilted) - 1.3.1-1
...
## rviz_2d_overlay_plugins (humble) - 1.3.1-1
